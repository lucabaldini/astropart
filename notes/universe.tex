...
\section{Measuring the universe}\label{sec:cosmic_ladder}
...
\begin{marginfigure}[]
	\input{figures/astronomical_dimensions.pgf}
...
\begin{figure}[htbp!]
	\input{figures/au_measurements.pgf}
...
\begin{figure}[htbp!]
	\input{figures/leavitt_1912.pgf}
    ...
    from its period typically within $\sim 0.3$ magnitudes, i.e., a factor of 2.}
	%\labfig{normalmonalisa}
\end{figure}
...
this has anything to do with the age of the universe, that it better be of the same
...
\begin{marginfigure}
  \input{figures/atmospheric_density.pgf}
...
\begin{marginfigure}
  \input{figures/atmospheric_grammage.pgf}
...
\end{align}
(The reader is referred to \cite{1994Walt} for the exact definition of the
...
\begin{marginfigure}
  \input{figures/gravitational_energy.pgf}
...
\begin{marginfigure}
	\input{figures/sun_pm_fictional.pgf}
...
\begin{figure}[htbp!]
	\input{figures/astronomical_catalogues.pgf}
...
\begin{marginfigure}
  \input{figures/planck_color_index.pgf}
...
\begin{figure*}[!tbp]
  \input{figures/herzprung_russel_diagram.pgf}
...
\begin{marginfigure}
    \input{figures/bolometric_correction.pgf}
...
the number density $n = N/V$ or, equivalently, the radius $R$ of the star
...
\begin{marginfigure}
	\input{figures/white_dwarf_fermip_nr.pgf}
...
\begin{figure}[htbp!]
	\input{figures/white_dwarf_mass_radius.pgf}
...
\begin{marginfigure}
  \input{figures/pulsar_minimum_density.pgf}
...
\begin{marginfigure}
  \input{figures/pulsar_rotational_energy.pgf}
...
\begin{figure}[htbp!]
	\input{figures/pulsar_period_pdot.pgf}
...
\begin{marginfigure}
	\input{figures/galaxy_rotation.pgf}
