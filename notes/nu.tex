...
\end{align*}
We can then rewrite our probability as
\begin{align*}
...
\begin{align*}
  \int_{r_0}^{r_1} \sqrt{\frac{1}{r} - \frac{1}{r_1}} \diff{r} =
  \sqrt{\frac{Z_1 Z_2 e^2}{E}} \int_{x_0}^{1} \sqrt{\frac{1}{x} - 1} \diff{x}.
\end{align*}
Since $x_0 = \nicefrac{r_0}{r_1} \ll 1$, we can start the integration from zero, and
approximate the quantity we are trying to calculate as
\begin{align*}
  \sqrt{\frac{Z_1 Z_2 e^2}{E}} \int_0^1 \sqrt{\frac{1}{x} - 1} \diff{x} =
  \frac{\pi}{2} \sqrt{\frac{Z_1 Z_2 e^2}{E}}.
\end{align*}
Putting everything back together, the crossing probability can be estimated as
\begin{align}
...
is typically scattered in the forward direction, which means that not only we are
...
producing more regular circles. The Super-Kamiokande measurement of the flux of
$\ce{^8B}$ neutrinos, amounting to some $0.45$ of the SSM prediction, constitutes
a turning point in the solar neutrino saga.
