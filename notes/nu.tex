...
a $W$ or a $Z$ vector boson. Of you are proficient in the art of Feynman diagrams,
you are all set.
...
\begin{feynman}
  \diagram [horizontal=a to b] {
    i1 [particle=\(\nu\)] -- [fermion] a -- [fermion] f1 [particle=\(\nu\)],
    i2 [particle=\(f\)]  -- [fermion] b -- [fermion] f2 [particle=\(f\)],
    a -- [boson, edge label=\(Z^0\)] b,
  };

  \begin{scope}[xshift=3cm]
  \diagram [horizontal=a to b] {
    i1 [particle=\(\nu_\ell\)] -- [fermion] a -- [fermion] f1 [particle=\(\ell^-\)],
  ...
  \diagram [horizontal=a3 to b3] {
    i5 [particle=\(\bar{\nu}_\ell\)] -- [anti fermion] a3 -- [anti fermion] f5 [particle=\(\ell^+\)],
    i6 [particle=\(p\)]              -- [fermion]      b3 -- [fermion]      f6 [particle=\(n\)],
...
\end{tikzpicture}
\caption{Feynman diagrams for neutrino neutral- and charged-current interactions.}
\end{figure}
...
% \begin{tikzpicture}
% \begin{feynman}
%   \diagram [horizontal=v to o1] {
%     i1 [particle=\(\nu_\ell\)] -- [fermion] v -- [fermion] o1 [particle=\(\ell^-\)],
%     i2 [particle=\(n\)]       -- [fermion] v -- [fermion] o2 [particle=\(p\)],
%   };
%   \node at ($(v)+(0,0.9)$) {\(\displaystyle \frac{G_F}{\sqrt{2}}\)};
% \end{feynman}
% \end{tikzpicture}
% \caption{Charged-current Fermi interaction: \(\nu_\ell n \to \ell^- p\).}
% \end{figure}
