...
Kamiokande and Super-Kamiokande, a deep-underground tank containing 50~kton of
pure water equipped with $11,200$ photomultiplier tubes, operated in Japan between
1996 and 2007.

The detection principle is interesting: as the nuclear neutrino capture is suppressed
in oxygen, the basic interaction mechanism for neutrinos is the elastic scattering
on the atomic electrons. This is qualitatively different from the radiochemical
experiments\sidenote{Historically, another notable difference is that water \cherenkov\
experiments were the first to detect neutrino in real time.}
...
light manifests itself in the form of rings, as opposed to full circles (see
figure~\ref{fig:cherenkov_ring}).
...
producing more regular circles.
