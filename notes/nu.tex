...
We note that the annihilation gamma rays are not always explicitly indicated in
...
dimension of an area, you have basically exhausted your degrees of freedom.
For a nuclear, beta-type transition
\begin{align*}
  \nu_e + n \rightarrow p + e^-,
\end{align*}
the interaction cross-section necessarily has to scale as\sidenote{For coherent
nuclear scattering on a nucleus with $N = A - Z$ neutrons, the cross section is
enhanced by a factor $N^2$.}
\begin{align*}
