...
the protons is also a thing, but detecting a protont with a MeV energy is much more
challenging.}. This is qualitatively different from the radiochemical experiments in that,
while the latter are only sensitive to $\nu_e$, \emph{water \cherenkov\ experiments are
sensitive to all three generations of neutrinos} via the reactions:
\begin{align*}
