...
FIGURE_FOLDER_PATH = ROOT_FOLDER_PATH / 'figures'
MACRO_FOLDER_PATH = ROOT_FOLDER_PATH / 'macro'
DATA_FOLDER_PATH = MACRO_FOLDER_PATH / 'data'
...
def save_cf(file_name : str = None, file_types : str = ('pgf', ),
    folder_path : str = FIGURE_FOLDER_PATH):
    ...
    for file_type in file_types:
        file_path = FIGURE_FOLDER_PATH / f'{file_name}.{file_type}'
