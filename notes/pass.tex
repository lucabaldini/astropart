...
are, generally speaking, negligible for the former. Given that, in principle, all
...
\begin{marginfigure}
  \input{figures/muon_ionization_loss.pgf}
...
\begin{marginfigure}
  \input{figures/muon_stopping_power.pgf}
...
\begin{marginfigure}
  \input{figures/critical_energy.pgf}
...
\begin{marginfigure}
  \input{figures/multiple_scattering.pgf}
...
\begin{marginfigure}
  \input{figures/em_shower_feynman.pgf}
...
\begin{marginfigure}
  \input{figures/em_shower_naive.pgf}
...
\begin{marginfigure}
  \input{figures/shower_longitudinal_profile.pgf}
...
\begin{marginfigure}
  \input{figures/cherenkov_effect.pgf}
