...
\begin{align*}
  \begin{cases}
  v_x = v_\perp \cos(\Omega_\gyrorad t) = c \sqrt{1 - \mu^2} \cos(\Omega_\gyrorad t)\\
  v_y = v_\perp \sin(\Omega_\gyrorad t) = c \sqrt{1 - \mu^2} \sin(\Omega_\gyrorad t) \\
  v_z = v_\parallel  = c\mu
  \end{cases}
\end{align*}
