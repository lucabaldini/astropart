...
identifications (ionization detectors, \cherenkov\ detectors and/or transition
radiation detectors), and it is fair to say that the different techniques are
...
typical solid-state tracking detector.
