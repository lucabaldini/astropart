...
of a generally smaller acceptance. Calorimetric experiments can be be more easily
optimized for a large acceptance and energy reach, and, as we shall see in the
following, can be declined in several different flavors, some of which are
specifically tailored for gamma-ray measurements. All modern instruments are equipped
with ancillary systems for particle identifications, and it is fair to say that the
different techniques are largely complementary.
...
at particle identification, e.g., for isotopic composition studies. This all
