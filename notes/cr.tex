...
while.}.
If you think about for a second, for any give particle, you can ask yourself four very
fundamental questions\sidenote{You might argue that polarization should be included in
this list, but that is beyond the scope of these notes.}:
\begin{enumerate}
