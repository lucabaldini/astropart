...
energy $E$ and the momentum component $p_x$ along the $x$-axis. The first transformation,
from the laboratory frame to the cloud frame, is given by\sidenote{Note again that, here
...
\end{align}
(Make sure you understand the $+$ on the right-hand side of both equations is due
to the fact that the particle is moving toward negative $x$ values. The equations
hold both for head-on and following collisions, as for the latter two minus
signs---for $\beta$ and $\cos\theta$---cancel out.)
