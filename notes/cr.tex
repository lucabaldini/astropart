...
\begin{table}[htbp!]
  ...
  \begin{tabular}{llll}
    ...
    \hline
    \hline
    AMS-02 & Spectrometer & & 2011--\\
    PaMeLa & Spectrometer & & 2006--2011\\
    CALET & Calorimeter & & 2015--\\
    DAMPE~\cite{2017APh....95....6C} & Calorimeter &  & 2015--\\
    Comptel & Compton & & 1991--2000\\
    ...
    HAWC & Water Cherenkov & & 2015--\\
    LHAASO & Water Cherenkov & & 2019--\\
    IceCube & Ice Cherenkov &  & 2010--\\
    ARGO-YBJ & Surface array &  & 2007--2013\\
    AUGER & Various & & 2008--\\
    \hline
  \end{tabular}
\end{table}
    ...
    \node{Ground-based detectors}
      ...
      child {node [xshift=1.8cm] (light) {Light}
        child {node [xshift=-1.2cm] (cherenkov) {\cherenkov}
          child {[xshift=-0.5cm, yshift=-0.2cm] node {Water}}
          child {[xshift=0cm, yshift=-0.2cm] node {Ice}}
          child {[xshift=0.5cm, yshift=-0.2cm] node {Air ($\gamma$ rays)}}
        }
